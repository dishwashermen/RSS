	...
	if ($post) {
		...
		foreach ($_POST as $key => $val) {
			...
			if ($InitKey) {
				...
				if (! Preg_match('/ProjectId|UserId|DirectRule|Autofill|StateIndex|HistoryState|HistoryIndex|Total|Difference|DiffContent|JournalIndex|JournalState|Limit|ViewContent/', $key)) {
